...
public class LawyerListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setupListeners() {
        adapter.setOnItemClickListener(abogado -> {
            Intent intent = new Intent(LawyerListActivity.this, PerfilActivity.class);
        ...
        adapter.setOnAdminOptionsClickListener(new LawyerAdapter.OnAdminOptionsClickListener() {
            ...
            public void onDeleteClick(Abogado abogado) {
                // 4. Delegar la acción de eliminar al ViewModel
                viewModel.removeAbogado(abogado);
                Toast.makeText(LawyerListActivity.this, "Abogado eliminado", Toast.LENGTH_SHORT).show();
            }
        });
